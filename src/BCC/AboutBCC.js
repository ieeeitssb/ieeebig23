    ...
    <section className="w-full p-5 min-h-[600px] bg-light dark:bg-dark bg-cover">
      <div className="container">
        ...
        <Accordion
          ...
          The Business Case Competition exists as a platform that encourages participants to
        ...
        />
        <Accordion
          question="what is the impact by joining BCC?"
